    ...
    <header className="flex flex-col lg:flex-row lg:space-x-8">
      <div className="flex flex-col items-start place-content-center gap-2 mt-12 lg:w-2/3">
        ...
        <div className="inline-flex overflow-visible">
          <h1 className="text-5xl font-bold bg-gradient-to-r mr-3 pb-3">Yanis<span className="sr-only"> Capelle — Fullstack Developer</span></h1>
      ...
      <div className="w-full h-full flex justify-center items-end">
        <img src={Moi} alt="Yanis Capelle, fullstack web developer" className="rounded-full h-56" />
      </div>
    </header>
  );
}
